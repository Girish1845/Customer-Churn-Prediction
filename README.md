...
- Description: The dataset contains customer demographic information, services subscribed, billing details, and a target column (Churn) indicating whether the customer left the service.
